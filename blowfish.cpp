...
void Blowfish::encryptBlock(u_int *high, u_int *low)
{
    u_int l = *high;
    u_int r = *low;
    for (int i = 0; i < N; i++)
...
void Blowfish::decryptBlock(u_int *high, u_int *low)
{
    u_int l = *high;
    u_int r = *low;
    for (int i = N + 1; i > 1; i--)
...
u_int Blowfish::iterationFunc(u_int x)
{
    u_char a, b, c, d;
    d = (u_char)(x & 0xFF);
    x >>= 8;
...
const u_int Blowfish::ORIG_P[N + 2] = {
...
const uint Blowfish::ORIG_S[4][256] = {
